...
export function PrivacyPolicy() {
    return (
        ...
        >
            ...
            <h2>Your Rights</h2>
            <p>You have the right to access, correct, or delete your personal information at any time. Contact us at privacy@ysale.com for any requests.</p>

            <h2>Contact Us</h2>
            <p>If you have any questions about this Privacy Policy, contact us at privacy@ysale.com</p>
        </ContentPage>
    );
}
